...
DESTDIR=%{buildroot} zig build \
    --summary all \
    --prefix "%{_prefix}" \
    --system "%{_builddir}/ghostty-offline-cache/p" \
...
%changelog
* Tue Apr 07 2026 Logic-H <19342546+Logic-H@users.noreply.github.com> - 1.3.1-1
- EL10 override spec for GitHub Actions builds
